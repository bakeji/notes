...
export default function SettingsPage(){
    ...
    return(
        <>
        <button onClick={()=>setShowSelectedSetting(false)} className={`items-center  mb-3  text-[14px] font-[400] hidden max-lg:flex gap-2 `}> 
        <Image width={18} height={18} src='/left.png' alt="go back"/>Settings</button>
