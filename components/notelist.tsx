        ...
        <div className="w-[25%] border-r-[1px] border-solid border-[#E0E4EA]">
            ...
            <div className="w-[95%] flex justify-center gap-2 flex-col mt-[20px]">
               ...
               {!archivedNotes && showArchivedNote  && <div className="bg-[#F3F5F8] rounded-[6px] w-[100%] border-[1px] border-solid border-[#E0E4EA] p-[2px]">
                ...
                <div key={index} className={`w-[100%] border-t-[1px] border-solid border-[#E0E4EA] p-[2px] ${selectedNotes && selectedNotes.title===note.title?"bg-[#F3F5F8] rounded-[6px] border-none": ''}`} >
                    <p onClick={()=>{handleNoteClick(note)}} className=" cursor-pointer font-inter text-[16px] font-[600] text-[#0E121B] lin">{note.title}</p>
